...
class TimerController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        makeLabel(label: rewardLabel, text: "Experience gained: 0", rect: CGRect(x: width/2 - 185, y: 400, width: 370, height: 50), font: UIFont(name:"HelveticaNeue-Thin", size: 25)!)
        ...
        finishButton.frame = CGRect(x: width/2-75, y: center + 200, width: 150, height: 40)
    ...
    func finishPressed(_ sender: UIButton!) {
        if timeLabel.text != "00:00:00" {
            ...
            User.sharedUser.totalXP += -Int(startTime.timeIntervalSinceNow*1/18)
    ...
    func updateTimer() {
        ...
        rewardLabel.text = "Experience gained: \(-Int(startTime.timeIntervalSinceNow*1/18))"
